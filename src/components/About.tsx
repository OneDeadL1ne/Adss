...
export default function About({
	...
	return (
		<div className="@container">
			<div className="flex justify-center items-start @[650px]:items-center  h-screen scroll-mt-[70px] text-white">
				<motion.div
					className="h-[1000px] w-[1000px] rounded-full bg-[#65646A] right-0 "
					animate={{ y: -500, x: 600, position: "absolute", scale: [0, 0, 1] }}
				...
				<div className="ml-[50px] mr-[50px] mt-[40px] @[800px]:ml-[100px] @[800px]:mr-[100px] @[800px]:mt-0 z-20">
					<div className="grid grid-rows-3 z-20 gap-2 ">
						...
						<p className="text-wrap  text-[20px] ">
							Увеличиваем дою рынка, улучшаем сервис, повышаем лояльность и продажи,
