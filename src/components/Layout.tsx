...
export default function Layout() {
	...
	const props: BurgerProps = { aboutRef, serviceRef, portfolioRef, contactsRef };
	...
	return (
		<div className="flex flex-col min-h-screen bg-[#36353A]  ">
			<header className="z-10 sticky top-0 bg-[#65646A]   text-white @container">
				<div className="flow-root justify-center mt-3">
					...
					<div className="flex float-right ">
						...
						<Button className="inline-flex @[950px]:hidden mr-5">XD</Button>
					</div>
				</div>
			</header>
			<main
			...
			>
				<div ref={aboutRef} className="h-screen scroll-mt-[70px]" id="about">
					<h2 className="text-2xl font-bold mb-6">About</h2>
				</div>
				<div ref={serviceRef} id="service" className="h-screen scroll-mt-[70px]">
					<h2 className="text-2xl font-bold mb-6">service</h2>
				</div>
				<div ref={portfolioRef} id="portfolio" className="h-screen scroll-mt-[70px]">
					<h2 className="text-2xl font-bold mb-6">portfolio</h2>
				</div>

				<div ref={contactsRef} id="contacts" className="h-screen scroll-mt-[70px]">
