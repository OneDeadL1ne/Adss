    ...
    return (
        <div className="@container">
            <div className="flex justify-center bg-[#36353A]  items-center   scroll-mt-[70px] text-white ">
                <div>
                    <div>
                        <p className="text-center font-bold text-[60px]">
                            Портфолио
                        </p>
                    </div>
                                        ...
                                        <div className="order-1 flex justify-center items-center">
                                            <div>
                                                ...
                                                <p className="w-[300px] text-wrap text-center  @[900px]:text-start">
                                                    Социальная сеть для колледжа
                                                    с чатами, новостной лентой и
                                                    актуальным расписанием
                                                    занятий.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="order-1 flex justify-center items-center">
                                            <div>
                                                ...
                                                <p className="w-[300px] text-wrap text-center  @[900px]:text-start">
                                                    ...
                                                    позволяет отслеживать все
                                                    свои важные события: отпуск,
                                                    день рождения, годовщину,
                                                    окончание учебы, концерт и
                                                    многое другое.
                                                </p>
                                            </div>
                                        </div>
