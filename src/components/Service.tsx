...
export default function Service({
	...
	return (
		<div className="@container">
			<div className="flex justify-center  bg-[#65646A] items-center   scroll-mt-[1000px] text-white">
				<Tabs defaultValue="account" className="w-full mr-[100px] ml-[100px]">
					<TabsList className="grid w-full grid-cols-2  ">
						<TabsTrigger
							value="account"
							className="data-[state=active]:border-b-2 p-2  border-[#A8ABAF]  uppercase"
						>
						...
						<div className="grid grid-rows-3 @[900px]:grid-cols-3 justify-center">
							<div className="justify-center">
								...
								<p>
									...
									Кросс-платформенное приложение, основываясь на смоем многолетнем
									опыте разработки
								</p>
								<Button
							...
							<div>
								...
								<p>
									Проанализируем текущее состояние проекта, предложим пути решения
									и доработаем его до нужного результата
								</p>
								<Button
									className="text-[17px]  bg-transparent hover:bg-gray-400"
									onClick={OnClick}
					...
					<TabsContent value="password">
						<div className="grid  grid-rows-3 grid-cols-2 @[900px]:grid-cols-5 justify-center">
							<div>
								<img src="/kotlin.png" className="h-[130px]" />
								<p>Kotlin</p>
							</div>
							<div>
